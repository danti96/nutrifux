	...
	<div class="container-fluid" style="overflow: auto;"  id="container_cont">
		<div class="container">
			<div style="padding: 50px 0;">
				<center><h3>Registro Especialidad</h3></center>
				...
				<form id="formulario" enctype="multipart/form-data" method="POST" autocomplete="OFF">
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" name="especialidad" id="especialidad" placeholder="Nombre de la Especialidad" required onkeypress="return soloLetras(event)">
					</div>		
					<div class="form-group">
						<label>Detalle *</label>
			 			<textarea class="form-control" name="detalle" id="detalle" placeholder="Detalle de la Especialidad" required></textarea>
					</div>		
					<div class="form-group"><center>
						<input type="submit" id="enviar" name="enviar" value="Registrar Especialidad" class="btn btn-info">
