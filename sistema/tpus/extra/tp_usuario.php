...
<br><br>
          ...
          <strong>Tabla de Tipo de Usuarios</strong>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <input type="text" class="form-control" name="detalle" id="detalle" placeholder="Tipo De Usuario" >
              </div>
            </div>
  ...
  cambiar();
       ...
       detalle=$("#frmeditartipo #detalle").val(),
        opcion=$("#frmeditartipo #opcion").val();
          $.ajax({
            ...
            data: {"id": id, "nombre": nombre, "detalle": detalle, "opcion": opcion}
          }).done( function( info ){
    ...
    var listar = function(){  
      var table = $("#example").DataTable({
        ...
        "searching": true,
          ...
          "columns": [
              {"className": 'text-center',"data": "tp_id"},
              {"data": "tp_nombre"},
              {"data": "tp_detalle"},
              {"data": "estado" },
    ...
    var obtener_data_editar = function(tbody, table){
      $(tbody).on("click", "button.editar", function(){
        ...
        var id=$("#frmeditartipo #id").val(data.tp_id), 
        nombre=$("#frmeditartipo #nombre").val(data.tp_nombre),
       detalle=$("#frmeditartipo #detalle").val(data.tp_detalle),
    ...
    var obtener_id_eliminar = function(tbody, table){
      $(tbody).on("click", "button.eliminar", function(){
        var data = table.row( $(this).parents("tr") ).data();
        var idusuario = $("#frmEliminarTipo #id").val( data.tp_id );
      });
    }
    var obtener_id_cambiar = function(tbody, table){
      $(tbody).on("click", "button.estado", function(){
        var data = table.row( $(this).parents("tr") ).data();
        var idusuario = $("#frmestadoTipo #id").val( data.tp_id );
      });
    }
