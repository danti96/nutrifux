...
<div class="container-fluid  contenido">
	...
	<div class="container-fluid"  style="overflow: auto;"  id="container_cont">
		<div style="height: 150px"><br>
			<center ><h3>Registro de Empleado</h3></center>
			<div style="padding: 10px;">
				<div>
					<div><a href="registrar.php" class="btn btn-info">Agregar Terapista<span style="padding-left: 10px;font-size:15px;"><i class="fas fa-plus-square"></i></span></a></div>
				</div>
			</div>
		</div>
    <!--===========================================-->
