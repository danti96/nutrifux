	...
	<div class="container-fluid" style="overflow: auto;"  id="container_cont">
		<div style="height: 150px"><br>
			...
			<div style="padding: 10px;">
				<div>
					<div><a href="registrar.php" class="btn btn-info">Agregar Cargo<span style="padding-left: 10px;font-size:15px;"><i class="fas fa-plus-square"></i></span></a></div>
				</div>
			</div>
		</div>
    <!--===========================================-->
  		<div class="table-responsive">
  		<section id="cargo_tabla"></section>
  		</div>
	</div>
</div>
