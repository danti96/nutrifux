	...
	<div class="container-fluid" style="overflow: auto;"  id="container_cont"> 
		<div class="container">
			<div style="padding: 50px 0;">
				<center><h3>Registro Cargo De Empleado</h3></center>
				<form id="formulario" enctype="multipart/form-data" method="POST" autocomplete="OFF">
					...
					<div class="form-group"><center>
						<input type="submit" id="enviar" name="enviar" value="Registrar Cargo" class="btn btn-info">
				 		<a href="cargo.php" class="btn btn-success" role="button" aria-pressed="true"><span style="padding-right: 5px;"><i class="fas fa-angle-double-left"></i></span> Volver</a>
					</center></div>	
				</form>
