<?php
	...
	$result_esp = $mysqli->query("SELECT esp_id, esp_nombre FROM especialidad");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="container-fluid  contenido">
	...
	<div class="container-fluid"  style="overflow: auto;"  id="container_cont">
		<div style="height: 150px"><br>
			<center ><h3>Administracion de Terapista</h3></center>
			<div style="padding: 10px;">
				<div>
					<div><a href="registrar.php" class="btn btn-info">Administrar Terapista<span style="padding-left: 10px;font-size:15px;"><i class="fas fa-plus-square"></i></span></a></div>
				</div>
			</div>
		</div>
    <!--===========================================-->
  		<div class="table-responsive">
  		<section id="empleado_tabla"></section>
  		</div>
  	</div>
</div>
