                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        <thead>
                            <tr>
                                ...
                                <th> <?php echo lang('esteticista'); ?></th>
                        ...
                        <?php foreach ($appointments as $appointment) { ?>
                            <tr class="">
                                ...
                                <td>
                                    <?php
                                    $doctor = $this->esteticista_model->getEsteticistaById($appointment->esteticista);
                        ...
                        <div class="col-md-9"> 
                            <select class="form-control m-bot15 js-example-basic-single" name="esteticista" value=''>  
                                ...
                                <?php foreach ($esteticistas as $esteticista) { ?>
                                    <option value="<?php echo $esteticista->id; ?>"<?php
                                    if (!empty($payment->esteticista)) {
                                        if ($payment->esteticista == $esteticista->id) {
                                            echo 'selected';
                                        }
                                    }
                                    ?>><?php echo $esteticista->name; ?> </option>
                                        <?php } ?>
                            </select>
                        </div>
                    </div>
