...
class Patient extends MX_Controller {
    ...
    public function index() {
        $data['suppliers'] = $this->suppliers_model->getEsteticista();
    ...
    public function addNew() {
        ...
        // Validating esteticista Field
        //   $this->form_validation->set_rules('esteticista', 'esteticista', 'trim|min_length[1]|max_length[100]|xss_clean');
