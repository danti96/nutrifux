                    ...
                    <div class="invoice-list">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-4 pull-left" style="text-align: left;">
                                <div class="col-md-12 row details" style="">
                                    <p>
                                        <label class="control-label"><?php echo lang('esteticista'); ?> <?php echo lang('name'); ?> </label>
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($prescription->doctor)) {
                                                $doctor = $this->esteticista_model->getEsteticistaById($prescription->doctor);
                                                echo $doctor->name;
                                            }
                                            ?>
                                        </span> 
                            ...
                            <div class="col-md-4 pull-right" style="text-align: left;">
                                ...
                                <div class="col-md-12 row details" style="">
                                    <p>
                                        <label class="control-label"> <?php echo lang('prescription'); ?> <?php echo lang('number'); ?>  </label>
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                ...
                                <div class="col-md-12 row details">
                                    <p>
                                        <label class="control-label"><?php echo lang('esteticista'); ?>  </label>
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($prescription->doctor)) {
                                                echo $this->esteticista_model->getEsteticistaById($prescription->doctor)->name . ' <br>';
                                            }
                                            ?>
                                        </span>
                                    </p>
