                    ...
                    <table class="table table-striped table-hover table-bordered" id="editable-sample">
                        ...
                        <?php foreach ($prescriptions as $prescription) { ?>
                            <tr class="">
                                ...
                                <td> <?php echo $this->esteticista_model->getEsteticistaById($prescription->doctor)->name; ?></td>
...
if ($this->ion_auth->in_group('Doctor')) {
    $doctor_id = $this->db->get_where('esteticista', array('ion_user_id' => $current_user))->row()->id;
}
?>
