                                    ...
                                    <form role="form" id="editLabForm" class="clearfix" action="lab/addLab" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="pos_doctor">
                                                ...
                                                <div class="col-md-8 lab pad_bot">
                                                    <div class="col-md-3 lab_label"> 
                                                        <label for="exampleInputEmail1"> <?php echo lang('esteticista'); ?> <?php echo lang('email'); ?></label>
                                                    </div>
                                                    <div class="col-md-9"> 
                                                ...
                                                <div class="col-md-8 lab pad_bot">
                                                    <div class="col-md-3 lab_label"> 
                                                        <label for="exampleInputEmail1"> <?php echo lang('esteticista'); ?> <?php echo lang('phone'); ?></label>
                                                    </div>
                                                    <div class="col-md-9"> 
                                ...
                                <div class="col-md-12 row details">
                                    <p>
                                        ...
                                        <span style="text-transform: uppercase;"> : 
                                            <?php
                                            if (!empty($lab->doctor)) {
                                                echo $this->esteticista_model->getDoctorById($lab->doctor)->name . ' <br>';
                                            }
                                            ?>
                                        </span>
                                    </p>
