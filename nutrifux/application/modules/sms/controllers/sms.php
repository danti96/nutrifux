...
class Sms extends MX_Controller {
    ...
    public function sendView() {
        ...
        $data['teams'] = $this->esteticista_model->getDoctor();
        $this->load->view('home/dashboard'); // just the header file
    ...
    function send() {
        ...
        if ($is_v_v == 'alldoctor') {
            $doctors = $this->esteticista_model->getDoctor();
    ...
    function appointmentReminder() {
        ...
        $doctor_detail = $this->esteticista_model->getDoctorById($appointment_details->doctor);
    ...
    function sendSmsDuringAppointment($patient, $doctor, $date, $s_time, $e_time) {
        ...
        $patient_detail = $this->patient_model->getPatientById($patient);
        $doctor_detail = $this->esteticista_model->getDoctorById($doctor);
