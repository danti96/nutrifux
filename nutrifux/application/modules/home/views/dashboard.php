                        ...
                        <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                            <li> <li class="sub-menu">
                                <a href="javascript:;" >
                                    ...
                                    <span><?php echo lang('esteticista'); ?></span>
                                </a>
                                <ul class="sub">
                                    <li><a href="esteticista"><i class="fa fa-user"></i><?php echo lang('list_de_esteticista'); ?></a></li>
                    ...
                    -->
                        ...
                        <?php if ($this->ion_auth->in_group(array('admin', 'Nurse', 'Laboratorist', 'Doctor'))) { ?>
                            <li class="sub-menu">
                                ...
                                <ul class="sub">
                                    ...
                                    <?php } ?>
                                    <?php if ($this->ion_auth->in_group(array('admin'))) { ?>
                                        <li><a  href="finance/esteticistaCommission"><i class="fa fa-edit"></i><?php echo lang('esteticista_commission'); ?> </a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                        <?php } ?>
                     <!--
                        ...
                        <?php if ($this->ion_auth->in_group('Accountant')) { ?>
                            ...
                            <li>
                                <a href="finance/esteticistaCommission" >
                                    <i class="fa fa-edit"></i>
                                    <span> <?php echo lang('esteticista_commission'); ?> </span>
                                </a>
                            </li>
                            <li>
