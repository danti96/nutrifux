...
--
-- Host: localhost:3306
-- Generation Time: Jan 31, 2020 at 08:58 PM
...
CREATE TABLE `appointment` (
  ...
  `esteticista` varchar(100) CHARACTER SET utf8 NOT NULL,
...
INSERT INTO `appointment` (`id`, `patient`, `esteticista`, `date`, `time_slot`, `s_time`, `e_time`, `remarks`, `add_date`, `s_time_key`, `status`) VALUES
...
(292, '2485', '142', '1579737600', '11:30 AM A 12:15 AM', '11:30 AM', '12:15 AM', 'CITA DE MASCARILLA', '01/23/20', '138', 'Pending'),
(293, '2485', '133', '1580083200', '01:00 PM A 02:00 PM', '01:00 PM', '02:00 PM', 'Primera Cita', '01/25/20', '156', 'Pending');
...
INSERT INTO `appointment1` (`id`, `patient`, `esteticista`, `date`, `time_slot`, `s_time`, `e_time`, `remarks`, `add_date`, `s_time_key`, `status`) VALUES
(290, '2476', '133', '1547593200', '12:15 PM A 01:15 PM', '12:15 PM', '01:15 PM', '', '01/15/19', '147', 'Approved'),
(291, '2476', '133', '1547593200', '02:45 PM A 02:15 PM', '02:45 PM', '02:15 PM', '', '01/15/19', '177', 'Approved');
...
--
-- Table structure for table `esteticista`
--
...
--
-- Dumping data for table `esteticista`
--

INSERT INTO `esteticista` (`id`, `img_url`, `name`, `email`, `address`, `phone`, `department`, `profile`, `x`, `y`, `ion_user_id`) VALUES
(133, '', 'Dr Reynaldo Juarez', 'doctor@dms.com', 'Collegepara, Rajbari', '+0123456789', 'Cardiology', 'MD Cardiology', '', '', '652'),
(142, NULL, 'Daniel Alvarado', 'daniel.tintin86@gmail.com', 'Av. Juan Tanca Marengo', '0987286055', 'Fisioterapia\r\n', 'FT. Fisioterapeuta', NULL, NULL, '686'),
(143, NULL, 'Karla Granda', 'Karla@gmail.com', 'Av. Machala && Av. Quito', '0991217584', 'Cardiologia', 'MD Cardiología', NULL, NULL, '687'),
(134, '', 'Dr Francisco Pizarro', 'Pizarro@dms.com', 'Collegepara, Rajbari', '+0123456789', 'Cardiology', 'MD Cardiology', '', '', '652');
...
(34, '2485', '<p>primera prueba del sistema de agendamiento de cita.<br />\r\n​paciente </p>\r\n', 'Agustin Filandro', '10 de Agosto', '0460511', NULL, '24-01-2020'),
(35, '2485', '<p>hola</p>\r\n\r\n<p>que haces</p>\r\n\r\n<p> </p>\r\n\r\n<p> </p>\r\n', 'Agustin Filandro', '10 de Agosto', '0460511', NULL, '27-01-2020');
...
INSERT INTO `patient` (`id`, `img_url`, `name`, `email`, `esteticista`, `address`, `phone`, `sex`, `birthdate`, `age`, `bloodgroup`, `ion_user_id`, `patient_id`, `add_date`, `how_added`) VALUES
...
(2484, 'uploads/picture-0012.png', 'PATRICIA AGUIRRE', 'patricia@gmail.com', '142', '9 Octubre', '0987286055', 'Female', '02-01-1990', NULL, 'A+', '693', '123272', '01/23/20', NULL),
(2485, 'uploads/danielworks2.png', 'Agustin Filandro', 'filandro@gmail.com', '143,142,133', '10 de Agosto', '0460511', 'Male', '02-05-1990', NULL, 'B-', '694', '412187', '01/23/20', NULL);
...
(1492, '2485', '1882', '1579975267', '500', '1882.gp', '1');
...
(1882, NULL, '2485', '0', '1579974492', '500', '0', NULL, NULL, '0', '0', '500', '0', '500', '0', NULL, 'USG - Embarazo Pro*400*diagnostic,Cuotas de admisión*100*others', '250', 'unpaid', '1', 'Agustin Filandro', '0460511', '10 de Agosto', '0', '25-01-20');
...
CREATE TABLE `payment_category` (
  ...
  `h_commission` int(100) NOT NULL DEFAULT '0'
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
...
(128, 'asd', 'asd ffdds', '50', 'others', 0, 0);
...
(1, 'NUTRIFUX', 'SISTEMA NUTRIFUX', 'av 2 de julioi', '+0123456789', 'tusolutionweb@gmail.com', '#', '$', 'spanish', 'flat', 'percentage', 'Login Title', 'uploads/logo-nonetext.png', '', '', '');
...
(50, '1577651243', '<p>FF</p>\r\n', 'Patient Id: 2476<br> Patient Name: Francisco pizarro<br> Patient Phone: +0123456789', '1');
...
(1, '127.0.0.1', 'admin', '$2y$08$veXd8te7xmKs4eF54ByGbu5LJbZv3BJiydS9z4oSyGzp0dSQUEMRe', '', 'admin@dms.com', '', 'eX0.Bq6nP57EuXX4hJkPHO973e7a4c25f1849d3a', 1511432365, 'zCeJpcj78CKqJ4sVxVbxcO', 1268889823, 1579972298, 1, 'Admin', 'istrator', 'ADMIN', '0'),
...
(614, '103.231.162.58', 'Susan Frisancho', '$2y$08$24jroN0vtsePjHUhuqUO3.1S1pSFU0qs3zJiQxeySYDBW9R/QjJPS', NULL, 'recepcionista@dms.com', NULL, NULL, NULL, NULL, 1505800835, 1577633581, 1, NULL, NULL, NULL, NULL),
...
(686, '127.0.0.1', 'Daniel Alvarado', '$2y$08$SE6png0guB423vyW4.mpHuTm2UGdlySGRRB1cfw2MBpZ3vanPO./e', NULL, 'daniel.tintin86@gmail.com', NULL, NULL, NULL, NULL, 1579460861, NULL, 1, NULL, NULL, NULL, NULL),
(687, '127.0.0.1', 'Karla Granda', '$2y$08$mXkdJNjlOTAjJjC9sUtzO.7HouedL6URlCeNAeSwfMK3G5GVD9pvm', NULL, 'Karla@gmail.com', NULL, NULL, NULL, NULL, 1579462300, NULL, 1, NULL, NULL, NULL, NULL),
(688, '127.0.0.1', 'Francisco Lopez', '$2y$08$MUV5aG7PA//dU3kHULtk8.PIv61PneuHGUgzA4eB0wx44V522IJBG', NULL, 'lopez@gmail.com', NULL, NULL, NULL, NULL, 1579500763, NULL, 1, NULL, NULL, NULL, NULL),
(693, '127.0.0.1', 'PATRICIA AGUIRRE', '$2y$08$zI3/QlPMZMOB/X.dQTUfKuw6hDrdJU9KRvOkrjcI1EH9xzXKXqyv6', NULL, 'patricia@gmail.com', NULL, NULL, NULL, NULL, 1579746233, NULL, 1, NULL, NULL, NULL, NULL),
(694, '127.0.0.1', 'Agustin Filandro', '$2y$08$HcPpMgnlENkXzkFrAeAL0uLcHWHS/ZAaADWreTUmq4u3WFC.NL7AO', NULL, 'filandro@gmail.com', NULL, NULL, NULL, NULL, 1579746783, NULL, 1, NULL, NULL, NULL, NULL);
...
--
-- AUTO_INCREMENT for table `esteticista`
--
ALTER TABLE `esteticista`
...
--
ALTER TABLE `patient`
  MODIFY `id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2488;
...
--
ALTER TABLE `users`
  MODIFY `id` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=695;
